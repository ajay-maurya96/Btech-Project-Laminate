const validateCurrentLiabilitiesLedgerInput = require('../../validators/groups/currentLiabilities');

function createCurrentLiabilitiesLedgerObject(input) {
    validateCurrentLiabilitiesLedgerInput(input);
...
module.exports = createCurrentLiabilitiesLedgerObject;
