const validateIndirectExpensesLedger = require('../../validators/groups/indirectExpenses');

function createIndirectExpensesLedgerSchema(input) {
    validateIndirectExpensesLedger(input);
...
module.exports = createIndirectExpensesLedgerSchema;
