const validateInvestmentLedger = require('../../validators/groups/investments');

function createInvestmentLedgerSchema(input) {
    validateInvestmentLedger(input);
...
module.exports = createInvestmentLedgerSchema;
