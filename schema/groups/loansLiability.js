const validateLoanLiabilityLedger = require('../../validators/groups/loansLiability');

function createLoanLiabilityLedgerSchema(input) {
  return {
    ENVELOPE: {
      HEADER: {
...
module.exports = createLoanLiabilityLedgerSchema;
