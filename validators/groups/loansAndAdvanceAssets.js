function validateLoanLedger(input) {
  ...
  if (input.parent !== "Loans & Advances (Asset)") {
    throw new Error("parent must be 'Loans & Advances (Asset)'");
  }
  ...
  // Banking is explicitly used
  if (!input.paymentDetails) {
    throw new Error("paymentDetails are mandatory for Loan ledger");
  }
...
module.exports = validateLoanLedger;
